...
main_application.title('yogi text editor')
...
about = ttk.Label(tool_bar,text='Made By:- Yogendra Singh')
about.grid(row=0,column=9,padx=5)
...
#### font family and font ssizze function
